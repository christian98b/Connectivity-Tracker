This project is a c# WPF .net 8 project.

Its a connectivtiy tracker for windows that checks how well the internet connection is.

Your workflow is as follows. You always use the todo.md file for tasks and the userstories.md file for context.
